                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="{{ $u->get_meta('phone') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
...
{{--                                        </div>--}}
                                            ...
                                            <div class="form-group">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="region">
                                                        <option value="sindh" @if($u->get_meta('region') == 'sindh') selected @endif>Sindh</option>
                                                        <option value="punjab" @if($u->get_meta('region') == 'punjab') selected @endif>Punjab</option>
                                                        <option value="kpk" @if($u->get_meta('region') == 'kpk') selected @endif>KPK</option>
                                                        <option value="balochistan" @if($u->get_meta('region') == 'balochistan') selected @endif>Balochistan</option>
                                                        <option value="gilgit_baltistan" @if($u->get_meta('region') == 'gilgit_baltistan') selected @endif>Gilgit Baltistan</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="city" class="form-control">
                                                    ...
                                                    <option class="option" value="CharsEdita">CharsEdita</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="distributor">
                                                    ...
                                                    @foreach($distributor as $dis)
                                                        <option value="{{$dis->id}}" @if($u->get_meta('distributor_id') == $dis->id) selected @endif>{{$dis->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="address">{{ $u->get_meta('address', 'N/A') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-form-label">Additional Information</label>
                                                <textarea class="form-control" name="additional_info">{{ $u->get_meta('additional_info', 'N/A') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
